...
import { FaShoppingCart, FaPalette, FaLaptopCode, FaSearchDollar } from "react-icons/fa";

// UPDATED FINAL SKILLS
const skills = [
  { name: "React", icon: <SiReact className="text-[#FF7A00]" /> },
  ...
  { name: "Vercel", icon: <SiVercel className="text-[#FF7A00]" /> },

  // Service-based skills
  { name: "E-Commerce Development", icon: <FaShoppingCart className="text-[#FF7A00]" /> },
  { name: "Branding & Graphic Design", icon: <FaPalette className="text-[#FF7A00]" /> },
  { name: "WordPress", icon: <SiWordpress className="text-[#FF7A00]" /> },
  { name: "Full Stack Development", icon: <FaLaptopCode className="text-[#FF7A00]" /> },

  // NEW SKILL YOU REQUESTED ⭐
  { name: "SEO & Digital Marketing", icon: <FaSearchDollar className="text-[#FF7A00]" /> },
];
