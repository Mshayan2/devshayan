...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { icon: <FaWhatsapp />, href: "https://wa.me/923141707750" },
    { icon: <FaEnvelope />, href: "mailto:devonicsolution1@gmail.com" },
    { icon: <FaInstagram />, href: "https://www.instagram.com/devonicsolutions?igsh=M3dsZmxnY29lbzl3" },
    { icon: <FaFacebook />, href: "https://www.facebook.com/share/1ASREa1j8D/" },
    { icon: <FaTiktok />, href: "https://www.tiktok.com/@devonic.solutions?_r=1&_t=ZN-91qurcGiOda" },
  ];
