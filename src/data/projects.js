import hireExpertImage from "../assets/Hire expert.PNG";
import havenBridgeImage from "../assets/Haven.PNG";
import devonicImage from "../assets/devonic.PNG";
...
export const projects = [
  {
    ...
    image: hireExpertImage,
    link: "https://gethireexpert.com/",
  },
  {
    title: "Haven Bridge",
    desc: "Full-stack property buying and selling app with CRUD operations, authentication, and REST API workflows.",
    image: havenBridgeImage,
    link: "https://github.com/Mshayan2/HavenBridge_full.git",
  },
  {
    title: "Devonic Solutions Website",
    desc: "Modern business website for a digital agency focused on services, engagement, and client conversion.",
    image: devonicImage,
    link: "https://github.com/Mshayan2/Devonic_Solutions.git",
  },
  {
    title: "Task Manager API",
    desc: "RESTful backend built with Node.js, Express.js, and MongoDB for task creation, updates, deletion, and retrieval.",
    image: taskManagerImage,
    link: "https://github.com/Mshayan2/taski-manager-express-js.git",
  },
  {
    title: "Portfolio Website",
    desc: "Modern responsive portfolio built with React.js, focused on UI/UX, performance, and responsiveness.",
    image: portfolioImage,
    link: "https://devshayan-seven.vercel.app/",
  },
  {
